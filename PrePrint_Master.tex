...
\include{PrePrint_Preamble}
\include{PrePrint_ScientificNotations}
...
\include{PrePrint_Sec00_Brainstorming} % 


\part{Data sets and analysis strategy}

\include{PrePrint_Sec01_Introduction} % Introduction
\include{PrePrint_Sec02_Datasets} % Data sets
\include{PrePrint_Sec03_EventSelections} % Event selections
\include{PrePrint_Sec04_TrackSelections} % Track and topological selections

\include{PrePrint_Sec05_Systematics} % Systematic checks


\part{Results and discussion}

\include{PrePrint_Sec06_Results} % Results
\include{PrePrint_Sec07_Discussion} % Discussion
...
\bibliography{aHDR_Bibliographie_JabRef,PrePrint_References}
