...
\newcommand {\pT}           {\ensuremath{p_{\text{\textsc{t}}}}}
...
\newcommand{\rmPhiMes}   {\mbox{$\mathrm {\phi(1020)}$}}
...
\newcommand{\rmXiM}     {\mbox{$\mathrm{\Xi}^{-}$}}
\newcommand{\rmXiPM}    {\mbox{$\mathrm {\Xi^{\pm}}$}}
...
\newcommand{\rmOmegaM}  {\mbox{$\mathrm {\Omega^{-}}$}}
\newcommand{\rmAomegaP} {\mbox{$\mathrm {\overline{\Omega}^{+}}$}}
\newcommand{\rmOmegas}  {\mbox{$\mathrm {\Omega^{-} \kern-0.3em +  \kern-0.1em \overline{\Omega}^{+}}$}}
\newcommand{\rmOmegaPM} {\mbox{$\mathrm {\Omega^{\pm}}$}} 
